...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * ,-----------------------------------------------------------.
   * |Esc|  1|  2|  3|  4|  5|  6|  7|  8|  9|  0|  -|  = |BS|BS | BS@Enter!
   * |-----------------------------------------------------------|
  ...
  [BASE_LAYER] = KEYMAP_60(
      ...
      MO(1),    KC_A,     KC_S,     KC_D,    KC_F,     KC_G,     KC_H,     KC_J,    KC_K,    KC_L,     KC_SCLN,  KC_QUOT,  KC_BSPC,    KC_ENT,  \
   ...
   */
   [FUNCTION_LAYER] = KEYMAP_60(
       ...
       __x__,   KC_HOME, KC_UP, KC_END, BL_TOGG,   __x__,   __x__, __x__, __x__,   __x__,  __x__,   __x__, __x__, __x__,  \
       KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, BL_INC,   __x__,   __x__, __x__, __x__, __x__, __x__,   __x__,    KC_DEL,  __x__,  \
       KC_LSFT, KC_NUBS,  KC_PGUP,   __x__,KC_PGDN,   __x__,   __x__,   __x__,   __x__,   __x__,   __x__,   __x__,    __x__,  __x__,  \
       KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             __x__,   KC_TRNS,  __x__,   __x__   \
   ),
  ...
  [SYSTEM_LAYER] = KEYMAP_60(
      RESET,  __x__,  __x__,  __x__,  __x__,  __x__,  __x__,  __x__,  __x__,  __x__,  __x__,  BL_DEC,  BL_INC,   BL_TOGG, \
      __x__,  __x__,  __x__,  __x__,  __x__,  __x__,  __x__,  __x__,  __x__,  __x__,  __x__,  __x__,  __x__,   __x__, \
      __x__,  __x__,  __x__,  __x__,  __x__,  __x__,  __x__,  __x__,  __x__,  __x__,  __x__,  __x__,  BL_TOGG,   __x__, \
